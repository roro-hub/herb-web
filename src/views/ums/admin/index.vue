  ...
  <div class="app-container">
    ...
    <div class="table-container">
      ...
      >
        ...
        <el-table-column label="公司" width="160" align="center">
          <template slot-scope="scope">
            {{
              scope.row.enterpriseId == -1 ? "全部" : scope.row.enterpriseName
            }}
          </template>
        </el-table-column>
...
export default {
  ...
  methods: {
    getEnterprise(enterprise) {
      if (enterprise) {
        this.admin.enterpriseId = enterprise.id;
      } else {
        this.admin.enterpriseId = -1;
      }
    },
    handleResetSearch() {
